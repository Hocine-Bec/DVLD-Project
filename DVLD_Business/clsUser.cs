...
namespace DVLD_Business
{
    public  class clsUser
    {
        ...
        private bool _AddNewUser()
        {
            ...
            this.UserID = UsersRepository.AddNewUser(usersDTO);
        ...
        {
            var usersDTO = UsersRepository.GetUserInfoByUserId(UserID);
        ...
        {
            var usersDTO = UsersRepository.GetUserInfoByPersonId(PersonID);
        ...
        {
            var usersDTO = UsersRepository.GetUserInfoByUsernameAndPassword(username, password);
        ...
        {
           return UsersRepository.IsUserExist(UserID);
        }

        public static bool isUserExist(string UserName)
        {
            return UsersRepository.IsUserExist(UserName);
        }

        public static bool IsUserExistByPersonId(int PersonID)
        {
            return UsersRepository.IsUserExistByPersonId(PersonID);
        }
